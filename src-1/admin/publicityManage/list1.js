            ...
            },
            {
                ...
                "render": function (data,type, full) {
                    ...
                    if(full.Status == 0 || full.Status == 5){
                        html +=  '<a href="#" class="btn btn-info btn-xs changeState" data-state="1" data-id=' + data + '>通过</a>';
                    }
                    if(full.Status == 0 || full.Status == 1){
                        //html += '<a href="#" class="btn btn-danger btn-xs changeState" data-state="5" data-id=' + data + '>不通过</a>';
                        html += '<a href="#" data-toggle="modal" data-target="#tradeModal" class="btn btn-danger btn-xs changeState1" data-state="5" data-loginname="' + full.LoginName + '" data-phone="' + full.Phone + '"data-id="' + full.ID + '"data-userid="' + full.userid + '">不通过</a>';
                    ...
                    if(full.Status == 3 || full.Status == 6){
                        html +=  '<a href="#" class="btn btn-info btn-xs changeState" data-state="4" data-id=' + data + '>通过</a>';
                    }
                    if(full.Status == 3 || full.Status == 4){
                        //html += '<a href="#" class="btn btn-danger btn-xs changeState" data-state="6" data-id=' + data + '>不通过</a>';
                        html += '<a href="#" data-toggle="modal" data-target="#tradeModal" class="btn btn-danger btn-xs changeState1" data-state="6" data-loginname="' + full.LoginName + '" data-phone="' + full.Phone + '"data-id="' + full.ID + '"data-userid="' + full.userid + '">不通过</a>';
                    }
                    if(full.Status == 1 || full.Status == 2 || full.Status == 4){
                        var text = full.IsRecommend==1?'取消推荐':'推荐';
                        html += '<a href="#" class="btn btn-success btn-xs btnRecommend" data-id=' + data + '>'+text+'</a>';
                    }
                    if(full.Status == 2){
                        html += '<a data-toggle="modal" data-target="#modal_evaluate" class="btn btn-warning btn-xs btnEvaluate" data-id="' + data + '" data-name="'+full.AchieveName+'" data-reviewcontent="'+full.ReviewContent+'" data-approvedate="'+full.ApproveDate+'">评</a>';
                    }
                    return html;
                }
            },
