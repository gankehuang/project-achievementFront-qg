...
$(function(){
    ...
    $("#sendDisscuss").on("click",function(e){
        ...
        if(param.acheID && param.message){
            ...
            jsonData = { "acheID": param.acheID,"userID":Util.getUserId(),"discussContent":param.message}
        }else if(param.disscussID && param.message){
            url = Util.service.ReplyDiscussByAchOwner;
            jsonData = {"jsonStr":JSON.stringify({disscussID:[param.disscussID]}),userID:Util.getUserId(),discussContent:param.message};
        }
