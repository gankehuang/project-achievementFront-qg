...
$(function () {
    ...
    //$('ResultSuitForProvincesID').attr("disabled", true);
    //var inputs = document.getElementsByTagName("input[type='checkbox']");//获取所有的input标签对象
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success === 1) {
                        ...
                        resetOtherName()
                        //显示种类其他具体名称
                        function resetOtherName()
                        {
                            if (Achievement.OtherName == "" || Achievement.OtherName == null) {
                                $("#qita").hide()
                            }
                            else {
                                $("#OtherName").html(Achievement.OtherName)
                            }
                        }
