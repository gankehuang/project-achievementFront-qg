/**
 * Created by wangyinping on 2017/6/12.
 */
...
$(function(){
    ...
    (function(){
        $.ajax({
            url: Util.service.GetRequirementByRequireIDYK,
            type: 'POST',
            data:{requireID:id},
            beforeSend: function () {
                Util.pageLoading();
            ...
            success: function (data) {
                ...
                if (data.success === 1) {
                    ...
                    if(Util.getUserId() && data.resultData.UserID == Util.getUserId()){
                        $("#recommendSelf").parent().hide();
                    }else if(Util.getUserId()){
                        $("#recommendSelf").parent().show();
                    }
                }else{
                    console.error("系统错误");
                }
    ...
    $("#btn-recommend").on("click",function () {
        ...
        $.ajax({
            ...
            type: 'POST',
            data:{userID:Util.getUserId(),requireID:id,achID:achID, VisitID: manageVisitID},
            beforeSend: function () {
                Util.pageLoading();
            },
            success: function (data) {
