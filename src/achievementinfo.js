...
$(function () {
                ...
                success: function (data) {
                    ...
                    if (data.success === 1) {
                        ...
                        $.ajax({
                            ...
                            type: "POST",
                            data: { "classifyID": infoId, "start": 0, "length": 10, "draw": 1, "retrievalInfo": "{}", "VisitID": hbVisitID },
                            success: function (data) {
                        ...
                        $.ajax({
                            ...
                            success: function (data1) {
                                if (data1.success === 1) {
                                    ...
                                    //console.log('88888888888', loginnamenow);
    ...
    $("#mainMessage").on("click", ".btn-collection", function (e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: { "achID": id, "userID": Util.getUserId(), "VisitID": manageVisitID },
            beforeSend: function () {
                Util.pageLoading();
            },
            success: function (data) {
    ...
    $("#completeModal").on("click", ".btn-save", function () {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: { "acheID": id, "userID": Util.getUserId(), currentPrice: currentPrice, VisitID: manageVisitID },
            beforeSend: function () {
                Util.pageLoading();
            },
            success: function (data) {
    ...
    $("#checkModal2").on("click", ".submit", function () {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: { "acheID": id, "userID": Util.getUserId(), "discussContent": discussContent, VisitID: manageVisitID },
            beforeSend: function () {
                Util.pageLoading();
            },
            success: function (data) {
    ...
    var test = "http://wap.agrittex.com/fromshare/achievementdetail/" + id;
