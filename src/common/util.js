...
var Util = (function (api) {
    ...
    api.urlpath = 'http://10.123.56.148:9009/';
    //url
    api.service = {
        ...
        //密码修改验证旧密码
        PassWordRepeat: api.api + '/UserManageService.asmx/PassWordRepeat',
        /*******************发布成果*****************/
        //------获取最新联系方式-----
        ...
        GetAllApprovedInTradeRequireGX:api.api + '/FrontPage.asmx/GetAllApprovedInTradeRequireGX',
        ...
        //数据统计
        GetAllAchievementBySearch: api.api + "/AchievementManageService.asmx/GetAllAchievementBySearch",

        //产权单位
        GetALLOwnerOrganization: api.api + "/AchievementManageService.asmx/GetALLOwnerOrganization",
        //公告管理数据统计
        GetAllPublicityBySearch: api.api + "/PublicityService.asmx/GetAllPublicityBySearch",
        
        //用户管理数据统计    
        GetALLUserBySearch: api.api + "/UserManageService.asmx/GetALLUserBySearch",
        
        //知识产权的数量
        GetAllIPR: api.api + "/AchievementManageService.asmx/GetAllIPR",

        //获取已通过公示
        GetAllPublicityPassedByUserID: api.api + "/PublicityService.asmx/GetAllPublicityPassedByUserID",

        GetGSAmount: api.api + "/PublicityService.asmx/GetGSAmount",  //公示金额
        GetGGAmount: api.api + "/PublicityService.asmx/GetGGAmount",  //公告金额 
        GetAllPublicityPassed: api.api + "/PublicityService.asmx/GetAllPublicityPassed",  //最终通过公示

        GetAchievementForNationalAward: api.api + "/AchievementManageService.asmx/GetAchievementForNationalAward",  //国家奖  
        GetAchievementForHundredItems: api.api + "/AchievementManageService.asmx/GetAchievementForHundredItems",  //百项
        GetAchievementForThousandItems: api.api + "/AchievementManageService.asmx/GetAchievementForThousandItems",  //千项
