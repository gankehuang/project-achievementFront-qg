...
$(function(){
    ...
    var drawTable = $("#dataTable").DataTable({
        ...
        "ajax": {
            ...
            },
            {
                ...
                "className": "text-center",
                "render": function (data, type, full) {
                    var html = '<a href="detail.html?id=' + data + '" title="查看" target="_blank">查看</a>'
                    return html;
                }
            }
        ],
    ...
    var drawTable1 = $("#dataTable1").DataTable({
        ...
        "ajax": {
            ...
            },
            {
                ...
                "render": function (data, type, full) {
                    //if(!full.IsApprove){
                    if ((full.IsApprove == 0 && full.IsInstitutesApprove == null) || (full.IsInstitutesApprove == 1 && full.IsApprove == 1)) {
                    //if (full.IsApprove == 0 || full.IsInstitutesApprove == 1) {
    ...
    $("#dataTable1").on("click",".btnPass",function(e){
        ...
        Util.confirm("请确认审核通过", function () {
            ...
            $.ajax({
                url: Util.service.IsApprovebySJpass,
                type: 'POST',
                data: { state: 1, "achID": id, IsInstitutesApprove: 2 },
                beforeSend: function () {
                    Util.pageLoading();
                },
    ...
    $("#tradeModal").on("click", ".submit", function (e) {
        ...
        $.ajax({
            url: Util.service.IsApprovebySJ,
            type: 'POST',
            data: {
                "achID": achid,
                "DataFlag": 1,
